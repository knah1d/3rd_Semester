...
public class CreditInquiry {
    ...
    private void readRecords() {
        ...
        try // read records
        {
            // open file to read from the beginning
    ...
    // use record type to determine if the record should be displayed
    ...
    public void processRequests() {
        // get the user's request (e.g., zero, credit, or debit balance)
